...
type DashboardChartsProps = {
  ...
  sessionBreakdown: BreakdownPoint[];
};

export function DashboardCharts({ equityCurve, strategyBreakdown, sessionBreakdown }: DashboardChartsProps) {
  return (
    <section className="grid gap-4 lg:grid-cols-3">
      <article className="rounded-xl border border-slate-800 bg-slate-900 p-4 lg:col-span-2">
      ...
      <article className="rounded-xl border border-slate-800 bg-slate-900 p-4">
        <h3 className="mb-3 text-sm font-semibold text-slate-100">Sessions</h3>
        <div className="h-64 w-full">
          <ResponsiveContainer>
